              ...
              children: [
                ...
                //  decoration: AppStyles.decoration2(widget.fieldText!),
                  ...
                  decoration: InputDecoration(
                   ...
                   contentPadding: EdgeInsets.only(left: 1,right: 10,bottom: 12,top: 12),
                    ...
                    border: UnderlineInputBorder(
                        borderRadius: BorderRadius.circular(25.0),
                        borderSide: BorderSide(
                            width: 1.0, color: ColorConstant.whiteA700)
                    ),
                    ...
                    focusedBorder: UnderlineInputBorder(
                        borderRadius: BorderRadius.circular(25.0),
                        borderSide:
                            BorderSide(width: 1.0, color: ColorConstant.whiteA700)),
                  ),
                ),
                GestureDetector(
                  onTap: (){
