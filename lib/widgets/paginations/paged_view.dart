...
abstract class PagedViewState<T> extends State<PagedView> {
  ...
  void initState() {
    ...
    // _pagingController = PagingController(
        // firstPageKey: _page,
        // getNextPageKey: (PagingState<int, T> state) {  }, fetchPage: (int pageKey) {  });
  ...
  @override
  void dispose() {
    // widget.onDispose?.call(PageModel<T>(data: _pagingController.itemList?.toList(), current_page: _page,lastLoaded: _lastLoaded));
