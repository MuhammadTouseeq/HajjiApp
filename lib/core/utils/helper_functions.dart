...
import 'package:hajji_app/core/utils/size_utils.dart';
import 'package:hajji_app/core/utils/utils.dart';
...
class HelperFunction {
  ...
  static String? idValidate(String val) {
    if (val.isEmpty) {
  ...
  static String? hajjidValidate(val, {fieldName}) {
    if (val.isEmpty || val == '') {
      return '${fieldName ?? ''}Please enter your valid ID.';
    } else {
      return null;
    }
  }
